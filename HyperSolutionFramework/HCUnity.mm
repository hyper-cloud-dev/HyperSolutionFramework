...
@implementation HCUnity

static id<HCUnityFramework> Unity_ufw;

+ (id<HCUnityFramework>)ufw {
    @synchronized (self) {
        return Unity_ufw;
    }
}

+ (void)setUfw:(id<HCUnityFramework>)ufw {
    @synchronized (self) {
        Unity_ufw = ufw;
    }
}

+ (id<HCUnityFramework>) launchWithOptions:(NSDictionary*)applaunchOptions {
